...
export default function Testimonials() {
  ...
  return (
    <section
      id="testimonials"
      className="relative w-full max-w-[960px] mx-auto px-4 sm:px-10 py-20 flex flex-col items-center justify-center text-center"
    >
      {/* 🧠 Title & Subtitle */}
...
const testimonials = [
  {
    text: "Klaimo sangat membantu saya memastikan dokumen klaim saya lengkap. Analisisnya cepat dan akurat banget!",
    image:
  ...
  {
    text: "Sekarang proses validasi dokumen jadi jauh lebih gampang. AI-nya cerdas dan hasilnya bisa dipercaya.",
    image:
  ...
  {
    text: "UI-nya clean banget, dan hasil prediksinya konsisten. Klaimo emang solusi cerdas buat klaim BPJS.",
    image:
